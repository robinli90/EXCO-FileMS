    ...
    internal class PDFGenerator
    {
        ...
        public void Generate_Invoice(string _ordernumber)
        {
            ...
            for (int num6 = 0; num6 < this.line_count; num6++)
            {
                ...
                for (int num12 = 1; num12 < Enumerable.Count<string>(this.order_info[num6]); num12++)
                {
                    if ((num12 % 4) == 1)
                    {
        ...
        public PdfPTable return_generated_column(string[] entries, int lines, [Optional, DefaultParameterValue(1)] int orientation)
        {
